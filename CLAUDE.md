...
2. **Rótulo de vista profesional** (hoy `show_title` = «Planta — 1:100» centrado en negrita): número en burbuja + título + «ESC. 1:N» + línea bajo el título, alineación, referencia `{lamina}` («1/A101»), y variante «barra vertical» de las capturas brasileñas (título / subtítulo / escala). Bajo.
