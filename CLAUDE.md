...
- Pendientes track: parser MFC legacy upstream (proyecto grande de reversing; referencia: crate Rust openskp del formato 2017), issue upstream por instance-tree misplacement, respuestas del maintainer.
