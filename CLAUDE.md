...
Red de regresión: 258 tests (incl. las 60 combinaciones de push del triángulo irregular `[(-0.2,-2.8),(2.7,-7.2),(4.1,-2.7)]`). Banco: `capturas/pris2.igz` (roto a propósito, sirve de bench de robustez sobre input dañado).
