...
7. **Marcas de sección en planta y llamadas de detalle**: proyectar `scene.section_planes` en los marcos de planta (línea, flechas, símbolo A-A) y llamada = recuadro a trazos + burbuja «3/L-05» apuntando a otro marco. Medio.
