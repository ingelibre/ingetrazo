...
3. **Cotas en cadena**: clics sucesivos → cotas alineadas que comparten la línea de cota, cota total apilada a +sep opcional; **estilo de cota por defecto de la lámina** (hoy solo copiar/pegar estilo). Medio.
