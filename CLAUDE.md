...
10. **v2:** planos profesionales (LayOut-equivalente), DWG/DXF (IngeCAD es el hermano 2D), IFC import; plugins: motor HECHO (2026-08-18), falta importer/exporter/panel registration + manifest + manager (post-0.5).
