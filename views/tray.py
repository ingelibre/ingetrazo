...
class MaterialsPanel(QWidget):
    ...
    def _fill_library_categories(self, root) -> None:
        ...
        (procedural, licence-clean textures generated by
        scripts/gen_textures.py), plus a Colours section and any loose PNGs
        the user dropped in resources/textures."""
        ...
        # Colours first (SketchUp has a Colors category too).
        grid = section(tr("Colors"))
        for i, rgb in enumerate(_LIBRARY_COLORS):
